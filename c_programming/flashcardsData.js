  ...
  overview: [
    {
      ...
      answer: "A program is a set of instructions that tells a computer how to solve a specific problem by interacting with the CPU."
    },
    {
      question: "What is an algorithm?",
      answer: "An algorithm is a step-by-step method or approach used to solve a problem."
    },
    {
      question: "What is the CPU?",
      answer: "The CPU (Central Processing Unit) is the brain of the computer where most instructions are executed."
    },
    {
      question: "What is memory (RAM)?",
      answer: "RAM (Random Access Memory) is a hardware component that stores program data temporarily while it is running. It is faster than hard drives but not persistent."
    },
    {
      question: "What is a hard drive?",
      answer: "A hard drive is a permanent storage device used to store files and resources, retaining data even after the computer is turned off."
    },
    {
      question: "What is the difference between RAM and a hard drive?",
      answer: "RAM is temporary, fast, and stores program data during execution, while a hard drive provides permanent storage for files and resources."
    },
    {
      question: "What is an operating system?",
      answer: "An operating system is software that manages computer hardware, resources, and user interactions, simplifying the use of a computer."
    },
    {
      question: "What is the fetch-execution cycle?",
      answer: "The fetch-execution cycle is the process where the CPU fetches instructions from memory, decodes them, and executes them repeatedly."
    },
    {
      question: "What is a high-level programming language?",
      answer: "A high-level programming language, like C, is abstract and closer to human language, making it easier to write and understand programs."
    },
    {
      question: "What is a compiler?",
      answer: "A compiler is a program that translates high-level source code into machine language instructions that the CPU can execute."
    },
    {
      question: "What are the steps in writing a program?",
      answer:
    ...
    {
      question: "Why is planning important in programming?",
      answer: "Planning helps ensure clear objectives and efficient design, reducing errors and making implementation smoother."
    },
    {
      question: "What does 'divide and conquer' mean in programming?",
      answer: "It refers to writing and testing small chunks of code incrementally to make debugging easier and more efficient."
    },
    {
      question: "What are examples of high-level programming languages?",
      answer: "Examples include C, Java, Objective-C, Swift, and Python."
    },
    {
      question: "What does a compiler check besides translating code?",
      answer: "It checks for syntax errors to ensure the code follows the rules of the programming language."
    },
    {
      question: "What is debugging?",
      answer: "Debugging is the process of finding and fixing errors in a program to ensure it works as intended."
    },
    {
      question: "Why is maintenance important for programs?",
      answer: "Maintenance ensures programs remain functional, fix bugs, and add new features after release."
    }
  ],
  features: [
      {
        question: "What type of programming language is C?",
        answer: "C is a general-purpose, imperative, and structured programming language."
      },
      {
        question: "What makes C general-purpose?",
        answer: "C can be used to write various applications, including operating systems, general programs, and embedded systems."
      },
      {
        question: "What is an imperative programming language?",
        answer: "It is a language organized around statements and variables, focusing on how to achieve a task step-by-step."
      },
      {
        question: "What are some modern features of C?",
        answer: "C includes control structures (e.g., conditional statements), functions, and variables, supporting top-down planning."
      },
      {
        question: "Why is C considered reliable and readable?",
        answer: "C code performs as expected and is easy to understand for those familiar with the language."
      },
      {
        question: "What types of programs are commonly written in C?",
        answer: "Word processors, spreadsheets, compilers, operating systems, and embedded system applications."
      },
      {
        question: "Why is C popular for embedded systems?",
        answer: "C provides efficient low-level access to memory and hardware with minimal runtime support, ideal for real-time programming."
      },
      {
        question: "What role does C play in operating systems?",
        answer: "C is heavily used in developing operating systems like UNIX, Linux, and macOS."
      },
      {
        question: "What does 'C is a subset of C++' mean?",
        answer: "All C programs are valid in C++, making it easier to transition to C++ after learning C."
      },
      {
        question: "Who created C, and when?",
        answer: "Dennis Ritchie created C in 1972 at Bell Laboratories for the development of the UNIX operating system."
      },
      {
        question: "What are the main goals of C?",
        answer: "To be useful, readable, and writable, enabling developers to write and understand code quickly and efficiently."
      },
      {
        question: "Why is standardization important in C?",
        answer: "It ensures that C code can run across different platforms and operating systems with a standard C compiler."
      },
      {
        question: "What are the main standards of C?",
        answer:
          "C89/C90: Widely supported and forms the basis of most C programs.\n" +
          "C99: Introduced new features, with partial compiler support.\n" +
          "C11: Latest standard with additional features, less widely adopted."
      },
      {
        question: "What are the benefits of learning C?",
        answer:
          "• Highly marketable skill.\n" +
          "• Core knowledge for transitioning to other languages like C++, Java, and Objective-C.\n" +
          "• Used in various industries for critical applications."
      },
      {
        question: "What makes C portable and hardware-independent?",
        answer: "C programs can run on multiple operating systems and hardware platforms due to its standardization and minimal hardware dependency."
      },
      {
        question: "What is the significance of C in modern programming?",
        answer: "Despite newer languages, C remains widely used due to its efficiency, simplicity, and foundational role in many systems and applications."
      }
    ],
  create: [
      {
        question: "What are the main features of C?",
        answer: "C is efficient, portable, powerful, flexible, and programmer-oriented."
      },
      {
        question: "Why is C considered efficient?",
        answer: "C code compiles to fast, compact machine instructions and allows fine-tuned memory management, leading to high efficiency."
      },
      {
        question: "What does portability in C mean?",
        answer: "You can compile the same C source code on different operating systems and hardware platforms with minimal or no changes."
      },
      {
        question: "Why is C considered powerful?",
        answer: "It offers direct access to hardware and memory, is used to write OS kernels (like UNIX/Linux), and many compilers/interpreters for other languages are written in C."
      },
      {
        question: "How does flexibility in C affect developers?",
        answer: "C’s flexibility allows multiple approaches to solve a problem and manage memory, but it also increases complexity and the potential for bugs."
      },
      {
        question: "What makes C a foundation for other languages?",
        answer: "C++ and Objective-C extend C’s syntax and concepts. Many modern languages build upon C, making it easier to transition after learning C."
      },
      {
        question: "Why is C popular for embedded systems?",
        answer: "It offers low-level control, minimal runtime overhead, and efficient use of system resources—ideal for constrained environments."
      },
      {
        question: "What are the disadvantages of C?",
        answer: "Pointers and manual memory management can cause complex bugs, and the wealth of operators can lead to code that’s hard to read."
      },
      {
        question: "What is the role of libraries in C?",
        answer: "Libraries provide pre-written functions for common tasks like I/O and file operations, making development faster and easier."
      },
      {
        question: "What are pointers in C?",
        answer: "Pointers store memory addresses, allowing direct data manipulation. They’re powerful but can introduce errors if used incorrectly."
      },
      {
        question: "Why might C require more developer responsibility?",
        answer: "Without automatic garbage collection, programmers must manually allocate and free memory, increasing the risk of errors."
      },
      {
        question: "What is a kernel, and why is it often written in C?",
        answer: "A kernel is the core of an operating system, managing memory and hardware. C’s low-level control makes it ideal for kernel development."
      },
      {
        question: "How does C handle bit-level operations?",
        answer: "C provides bitwise operators that let developers manipulate data at the bit level, enabling fine-grained hardware control."
      },
      {
        question: "Why is C suitable as a first programming language?",
        answer: "Its concise syntax and foundational concepts (like manual memory management) ease the transition to other languages later."
      },
      {
        question: "How does C remain programmer-oriented?",
        answer: "It offers direct memory access, a large set of operators, and a robust standard library, giving developers broad control and flexibility."
      }
    ]
